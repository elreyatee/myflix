...
describe PasswordResetsController do 
  describe "GET show" do 
    it "renders show template if the token is valid" do 
      ...
      aaron.update_column(:password_reset_token, '12345')
      get :show, id: '12345'
    ...
    it "sets @token" do 
      ...
      aaron.update_column(:password_reset_token, '12345')
      get :show, id: '12345'
      expect(assigns(:password_reset_token)).to eq('12345')
    end
  ...
  describe "POST create" do 
    context "with valid token" do 
      it "should redirect to sign in page" do 
        ...
        aaron.update_column(:password_reset_token, '12345')
        post :create, password_reset_token: '12345', password: 'new_password'
    ...
    context "with invalid token" do 
      it "redirects to expired token path" do
        post :create, password_reset_token: '12345', password: 'some_password'
        expect(response).to redirect_to expired_token_path
      end
    end
  end
